...
# of said molecule.
# 
# This code only focuses on the ADMET challenge. It trains a model for a single ADMET property.
...
parser = argparse.ArgumentParser(description="Train a model on a single ADMET property and store the predictions")
parser.add_argument("target", choices=["LogD", "HLM", "MDR1-MDCKII", "KSOL", "MLM"],
                    help="The single ADMET property to model.")
...
tgt = args.target
# TabPFN supports single-task modeling
...
# Do not submit the single property predictions
